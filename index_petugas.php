  ...
  <main class="form-signin w-100 m-auto">
    <form action="aksi_login_petugas.php" method="post">
      ...
      if ($file) {
        ...
        echo"
        <h4 class='fw-normal'>Login Admin or Petugas</h4>
      ...
      <div class="form-floating">
        <input type="text" class="form-control" name="txtusername" placeholder="Username" autofocus required>
      ...
      <a href="index.php">
        <h5 class="mt-2">Login Sebagai Siswa</h5>
      </a>
