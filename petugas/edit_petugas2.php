...
<body>
    <h1>Edit Petugas</h1>
    <h5>(Dengan Password)</h5>
    <hr>
    <form action="?url=aksi_edit_petugas2" method="post">
        ...
        <div class="form-group mb-2">
            ...
            <a href="?url=edit_petugas&id_petugas=<?= $data['id_petugas'];?>">Mau Edit tanpa Password?Klik sini</a>
        </div>
</body>
